    ...
    <div className="modal">
      <div className="modal__wrapper">
        <div className="modal__header">
          ...
          <CloseOutlined className="modal__header-close" onClick={handleCloseModal} />
        </div>
        <div className="modal__content">
          <div className="modal__content-description">
            <p className="modal__content-description__head">Description</p>
            <p className="modal__content-description__body">{product.description}</p>
          </div>
        ...
        <div>
          {loading ? (
            ...
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: '80%' }} aria-label="simple table" className="table">
                <TableHead>
                  <TableRow>
